...
export class HomeComponent implements OnInit {
  // @ViewChild('selectElem') elss:ElementRef;
  constructor(){}
  ...
  loadSlider(): void {
    ...
    function scroll($container, direction) {
        ...
        $container.find('ul li').each(function (index, element) {
            ...
            if (i !== undefined) {
                ...
                console.log($(element));
                console.log( i * config.distance + (1 - scales) * config.maxWidth * Number(i > halfShowNum))
                $(element).css({
                    display: 'block',
    ...
    console.log(document.getElementById("containerslider"));
        (<any>$("#containerslider")).carousel({
            num: 3,
            maxWidth: 300,
            maxHeight: 400,
            distance: 30,
